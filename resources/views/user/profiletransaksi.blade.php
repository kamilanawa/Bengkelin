                            ...
                            <div class="card my-3 p-5">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        {{-- tambahkan kondisi jika ada keterangan maka tampilkan, jika tidak jangan ditampilkan --}}
                                        @if ($item->keterangan)
                                            <div class="detail-booking d-flex justify-content-between align-items-center">
                                                <p style="margin: 0">Keterangan</p>
                                                <p style="margin: 0" class="fw-bold">{{ $item->keterangan }}</p>
                                            </div>
                                        @endif
                                        <div class="detail-booking d-flex justify-content-between align-items-center">
                                            ...
                                            @else
                                                <form action="{{ route('booking.rating', ['id' => $item->id]) }}"
                                                    ...
                                                    <div class="d-flex justify-content-between flex-column">
                                                        <div class="rating">
                                                            <input type="radio" @disabled($item->rating != null)
                                                        ...
                                                        <textarea name="review" id="review" cols="30" rows="3" class="form-control mb-2"
                                                            @disabled($item->rating != null)>{{ trim($item->review) }}</textarea>
                                                        <button type="submit"
